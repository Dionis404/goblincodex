...
const BASE_SKILLS: Skill[] = [
  ...
  { name: 'Greenhouse Gamble', tree: 'Greenhouse', tier: 3, points: 3, island: 'desert', description: '25% шанс получить +1 к урожаю тепличных культур' },
...
const SKILL_UPGRADES: Record<string, SkillUpgrade> = {
  ...
  'No Axe No Worries': { maxLevel: 3, effect: { kind: 'flatDebuff', ranks: [1, 0.75, 0.5] } },
  Catchup: { maxLevel: 3, effect: { kind: 'growthMultiplier', ranks: [0.9, 0.85, 0.8] } },
  'Fruity Woody': { maxLevel: 3, effect: { kind: 'additiveYield', ranks: [1, 1.5, 2] } },
  ...
  'Tree Turnaround': { maxLevel: 3, effect: { kind: 'chance', ranks: [15, 25, 40] } },
  ...
  'Greenhouse Gamble': { maxLevel: 3, effect: { kind: 'chance', ranks: [25, 35, 45] } },
  ...
  'Sea Blessed': { maxLevel: 3, effect: { kind: 'chance', ranks: [5, 7.5, 10] } },
